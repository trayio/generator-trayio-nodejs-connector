...
module.exports = class extends generators {
    ...
    async prompting() {
        ...
        const answers = await this.prompt([{
            ...
            },
            {
                type: 'confirm',
                name: 'rawHttp',
                message: 'Do you want to add rawHttpRequest?',
                default: true,
                when: answers => !answers.httpTrigger,
            },
        ]);
        this.title = title;
        this.name = name;
    ...
    createConnector() {
        ...
        if (this.rawHttp) {
            this.fs.copyTpl(
                this.templatePath(`${templateFolder}/rawHttpRequest.js`),
                this.destinationPath(`connectors/${this.name}/rawHttpRequest.js`), {},
            );
        }
        this.fs.copyTpl(
